-- RUN THIS SCRIPT AFTER IV&V REFRESH
...
UPDATE TM_FORMS_METADATA
SET FILE_PATH = replace(FILE_PATH, '\\hrinffp1001.WASHDC.STATE.SBU\ElectronicDocuments\Production\prd\', '\\hrewwnonprdfs01\ElectronicDocuments\IVV\ivv1\')

UPDATE TM_FORMS_METADATA
SET PDF_FILE_PATH = replace(PDF_FILE_PATH, '\\hrinffp1001.WASHDC.STATE.SBU\ElectronicDocuments\Production\prd\', '\\hrewwnonprdfs01\ElectronicDocuments\IVV\ivv1\')

-- UPDATE EAPS_REPORT_METADATA 

UPDATE EAPS_REPORT_METADATA 
SET REPORT_PARAMETERS = '<root>
  <reportServerUrl>https://hrivv.hr.state.sbu/ReportServer</reportServerUrl>
  <parameter>
...
UPDATE STD_APPLICATION
SET APP_VERSION_TXT = REPLACE(APP_VERSION_TXT, 'PROD', 'IVV')
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value ='https://hrivv.hr.state.sbu/ReportServer'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value ='https://hrivv.hr.state.sbu/ReportServer/ReportService.asmx'
WHERE EAPS_Config_Type = 'EAPS_REPORT_MANAGER_URL'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'https://hrivv.hr.state.sbu/ivv1/OPS'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'https://hrivv.hr.state.sbu/ivv1/gsr/'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01\ElectronicDocuments\IVV\ivv1\tm\tmfive\'
WHERE EAPS_Config_Type = 'TMPDFSERVICE_TM5CablePDFWritePath'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'https://hrivv.hr.state.sbu/ivv1/hrsar/'
WHERE EAPS_Config_Type = 'HRSAR_URL'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01\ElectronicDocuments\IVV\ivv1\tm\tmeight\'
WHERE EAPS_Config_Type = 'TMPDFSERVICE_TM8CablePDFWritePath'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'Data Source=HRIVVDB1218\HRIVVDB1218;Database=EAPS;Integrated Security=SSPI;'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'https://hrivv.hr.state.sbu/ivv1/eaps/'
WHERE EAPS_Config_Type = 'EAPS_URL'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01\ElectronicDocuments\IVV\ivv1\tm\ds1707\'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01\ElectronicDocuments\IVV\ivv1\tm\ds1552\'
...
--Added under ESSR 47329
--TC 08/23/2017
UPDATE [EAPS].[dbo].[EAPS_Config]
SET [EAPS_Config_Type_Value] = '\\hrivvws1029\HRWEB\ivv1\MClass\Images\MClassLogo.jpg'
...
UPDATE EAPS_API_HOST SET Query = REPLACE(Query, '.PRD', '.IVV1')
