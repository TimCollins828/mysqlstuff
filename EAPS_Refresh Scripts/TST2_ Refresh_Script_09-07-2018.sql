...
UPDATE HelpFiles
SET FilePath = REPLACE(FilePath, '\\hrinffp1001\Output\Production\prd\eaps\Help', '\\hrewwnonprdfs01\Output\Test\tst2\eaps\Help')

-- UPDATE TM_FORMS_METADATA

UPDATE TM_FORMS_METADATA
SET FILE_PATH = replace(FILE_PATH, '\\hrinffp1001.WASHDC.STATE.SBU\ElectronicDocuments\Production\prd\', '\\hrewwnonprdfs01.WASHDC.STATE.SBU\ElectronicDocuments\Test\tst2\')

UPDATE TM_FORMS_METADATA
SET PDF_FILE_PATH = replace(PDF_FILE_PATH, '\\hrinffp1001.WASHDC.STATE.SBU\ElectronicDocuments\Production\prd\', '\\hrewwnonprdfs01.WASHDC.STATE.SBU\ElectronicDocuments\Test\tst2\')

-- UPDATE EAPS_REPORT_METADATA 

UPDATE EAPS_REPORT_METADATA 
SET REPORT_PARAMETERS = '<root>
  <reportServerUrl>https://hrtst.hr.state.sbu/Reportserver</reportServerUrl>
  <parameter>
...
UPDATE STD_APPLICATION
SET APP_VERSION_TXT = REPLACE(APP_VERSION_TXT, 'PROD', 'TST2')
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value ='https://hrtst.hr.state.sbu/Reportserver'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value ='https://hrtst.hr.state.sbu/Reportserver/ReportService.asmx'
WHERE EAPS_Config_Type = 'EAPS_REPORT_MANAGER_URL'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'https://hrtst.hr.state.sbu/tst2/OPS'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'https://hrtst.hr.state.sbu/tst2/gsr/'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01.washdc.state.sbu\ElectronicDocuments\Test\tst2\tm\tmfive\'
WHERE EAPS_Config_Type = 'TMPDFSERVICE_TM5CablePDFWritePath'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'https://hrtst.hr.state.sbu/tst2/hrsar/'
WHERE EAPS_Config_Type = 'HRSAR_URL'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01.washdc.state.sbu\ElectronicDocuments\Test\tst2\tm\tmeight\'
WHERE EAPS_Config_Type = 'TMPDFSERVICE_TM8CablePDFWritePath'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'Data Source=HRTSTDB1218\TST2;Database=EAPS;Integrated Security=SSPI;'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'https://hrtst.hr.state.sbu/tst2/eaps/'
WHERE EAPS_Config_Type = 'EAPS_URL'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01.washdc.state.sbu\ElectronicDocuments\Test\tst2\tm\ds1707\'
WHERE EAPS_Config_Type = 'TMPDFSERVICE_DS1707PdfFileWritePath'


UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01.washdc.state.sbu\Output\Test\tst2\eaps\'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01.washdc.state.sbu\ElectronicDocuments\Test\tst2\tm\ds1552\'
...
UPDATE EAPS_API_HOST SET Query = REPLACE(Query, '.PRD', '.TST2')
