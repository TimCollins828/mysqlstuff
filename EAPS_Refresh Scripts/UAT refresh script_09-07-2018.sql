...
-- ASSUMPTION 
--	1. ON THE FILE SERVER (hrinffp1001),UAT\UAT1
--  2. REPORTING SERVER IS HRUATAP1026
...
UPDATE HelpFiles
SET FilePath = REPLACE(FilePath, '\\hrinffp1001\Output\Production\prd\eaps\Help', '\\hrewwnonprdfs01\Output\Test\uat\eaps\Help')

-- UPDATE TM_FORMS_METADATA

UPDATE TM_FORMS_METADATA
SET FILE_PATH = replace(FILE_PATH, '\\hrinffp1001.WASHDC.STATE.SBU\ElectronicDocuments\Production\prd\', '\\hrewwnonprdfs01.WASHDC.STATE.SBU\ElectronicDocuments\Test\uat\')

UPDATE TM_FORMS_METADATA
SET PDF_FILE_PATH = replace(PDF_FILE_PATH, '\\hrinffp1001.WASHDC.STATE.SBU\ElectronicDocuments\Production\prd\', '\\hrewwnonprdfs01.WASHDC.STATE.SBU\ElectronicDocuments\Test\uat\')

-- UPDATE EAPS_REPORT_METADATA 

UPDATE EAPS_REPORT_METADATA 
SET REPORT_PARAMETERS = '<root>
  <reportServerUrl>https://hrtst.hr.state.sbu/Reportserver_UAT</reportServerUrl>
  <parameter>
...
SET EMAIL_OVERRIDE_TXT = 'HREAPSAlertsNonProd@state.gov'

UPDATE STD_APPLICATION
SET APP_VERSION_TXT = REPLACE(APP_VERSION_TXT, 'PROD', 'UAT')
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value ='https://hrtst.hr.state.sbu/Reportserver_UAT'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value ='https://hrtst.hr.state.sbu/Reportserver_UAT/ReportService.asmx'
WHERE EAPS_Config_Type = 'EAPS_REPORT_MANAGER_URL'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'https://hruat.hr.state.sbu/uat/OPS'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'https://hruat.hr.state.sbu/uat/gsr/'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01.washdc.state.sbu\ElectronicDocuments\Test\uat\tm\tmfive\'
WHERE EAPS_Config_Type = 'TMPDFSERVICE_TM5CablePDFWritePath'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'https://hrtst.hr.state.sbu/uat/hrsar/'
WHERE EAPS_Config_Type = 'HRSAR_URL'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01.washdc.state.sbu\ElectronicDocuments\Test\uat\tm\tmeight\'
WHERE EAPS_Config_Type = 'TMPDFSERVICE_TM8CablePDFWritePath'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'Data Source=HRTSTDB1218\UAT;Database=EAPS;Integrated Security=SSPI;'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value = 'https://hruat.hr.state.sbu/uat/eaps/'
WHERE EAPS_Config_Type = 'EAPS_URL'

UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01.washdc.state.sbu\ElectronicDocuments\Test\uat\tm\ds1707\'
WHERE EAPS_Config_Type = 'TMPDFSERVICE_DS1707PdfFileWritePath'


UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01.washdc.state.sbu\Output\Test\uat\eaps\'
...
UPDATE EAPS_Config
SET EAPS_Config_Type_Value = '\\hrewwnonprdfs01.washdc.state.sbu\ElectronicDocuments\Test\uat\tm\ds1552\'
...
--Added from Mike Burkhart ESSR 46487 - 06-12-2017 - TC

UPDATE [EAPS].[dbo].[EAPS_Config]
SET [EAPS_Config_Type_Value] = '\\hrdevws1029\HRWEB\dev1\MClass\Images\MClassLogo.jpg'
WHERE [EAPS_Config_Type] = 'MCLASS_EMAIL_LOGO_PATH'


--essr 52553 JA update hr data service connection strings 09-07-2018

UPDATE EAPS_API_HOST SET Query = REPLACE(Query, '.PRD', '.UAT')
